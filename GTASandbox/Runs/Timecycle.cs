    ...
    class Timecycle : Run
    {
        ...
        protected override void Process()
        {
            ...
            for (int i = 0; i < cameras.Length; i++)
            {
                ...
                {
                    Natives.x0F07E7745A236711();
                    if (item != "None") Natives.x2C933ABF17A1DF41(item);
                    Natives.x82E7FFCD5B2326B3(0.5f);
                    Sleep(50);
                    Functions.Screenshot(0, 0, 1920, 1080, $"{Directory}//{item}_50", true);
                    Sleep(50);
                    Natives.x82E7FFCD5B2326B3(0.9f);
                    Sleep(50);
                    Functions.Screenshot(0, 0, 1920, 1080, $"{Directory}//{item}_90", true);
                    Sleep(50);
                    Natives.x0F07E7745A236711();
                    Sleep(50);
                }
